/**
 * @file color_yaml.h
 * @brief Defines the ColorVariantConverter for YAML serialization of Godot Color type.
 *
 * This file contains the ColorVariantConverter class which handles the conversion
 ...
 *
 * The ColorVariantConverter class provides functionality to:
