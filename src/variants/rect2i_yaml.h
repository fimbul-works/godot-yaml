/**
 * @file rect2i_yaml.h
 * @brief Defines the Rect2iVariantConverter for YAML serialization of Godot Rect2i type.
 *
 * This file contains the Rect2iVariantConverter class which handles the conversion
...
/**
 * @class Rect2iVariantConverter
 * @brief Converter for Godot Rect2i type to/from YAML format.
 *
 * The Rect2iVariantConverter class provides functionality to:
