/**
 * @file aabb_yaml.h
 * @brief Defines the AABBVariantConverter for YAML serialization of Godot AABB type.
 *
 * This file contains the AABBVariantConverter class which handles the conversion
...
/**
 * @class AABBVariantConverter
 * @brief Converter for Godot AABB type to/from YAML format.
 *
 * The AABBVariantConverter class provides functionality to:
