...
void PackedVector3ArrayVariantConverter::encode(ryml::NodeRef& node, const Variant& v, const Ref<YAMLStyle>& style) const
{
  ...
  const auto* vec_converter = VariantConverterRegistry::get_converter(Variant::VECTOR3);
