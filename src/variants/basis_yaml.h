/**
 * @file basis_yaml.h
 * @brief Defines the BasisVariantConverter for YAML serialization of Godot Basis type.
 *
 * This file contains the BasisVariantConverter class which handles the conversion
...
/**
 * @class BasisVariantConverter
 * @brief Converter for Godot Basis type to/from YAML format.
 *
 * The BasisVariantConverter class provides functionality to:
