/**
 * @file transform3d_yaml.h
 * @brief Defines the Transform3DVariantConverter for YAML serialization of Godot Transform3D type.
 *
 * This file contains the Transform3DVariantConverter class which handles the conversion
...
/**
 * @class Transform3DVariantConverter
 * @brief Converter for Godot Transform3D type to/from YAML format.
 *
 * The Transform3DVariantConverter class provides functionality to:
