...
void Vector2VariantConverter::encode(ryml::NodeRef& node, const Variant& v, const YAMLFormat::View& format) const
{
  const Vector2 vec = v.operator Vector2();
  YAMLFormat::Format fmt = format.get_format(Variant::VECTOR2);
