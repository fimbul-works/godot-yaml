...
/**
 * YAML converter for Vector3i type.
...
class Vector3iVariantConverter : public VariantConverter {
  ...
  private:
  void emit_as_map(ryml::NodeRef& node, const Vector3i& vec, const YAMLFormat::View& format) const;
  void emit_as_sequence(ryml::NodeRef& node, const Vector3i& vec, const YAMLFormat::View& format) const;
