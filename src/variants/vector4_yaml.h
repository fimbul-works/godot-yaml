/**
 * @file vector4_yaml.h
 * @brief Defines the Vector4VariantConverter for YAML serialization of Godot Vector4 type.
 *
 * This file contains the Vector4VariantConverter class which handles the conversion
...
/**
 * @class Vector4VariantConverter
 * @brief Converter for Godot Vector4 type to/from YAML format.
 *
 * The Vector4VariantConverter class provides functionality to:
