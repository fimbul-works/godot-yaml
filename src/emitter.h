/**
 * @file emitter.h
 * @brief Defines the YAML::Emitter class for serializing Godot types to YAML.
 *
 * This file contains the YAML::Emitter class which handles the conversion of
 ...
 *
 * The Emitter class handles the serialization of Godot Variant types to YAML
 ...
 *
 * Each Godot type is handled by a specialized VariantConverter, which is
 * managed by the ConverterFactory.
 */
class YAML::Emitter {
public:
	/**
	 * @brief Constructs a new Emitter instance.
	 *
...
private:
	 ...
	 * @param user_data User data pointer (typically the Emitter instance)
	 */
	 ...
	 * @return VariantConverter* The converter or nullptr if not found
	 */
