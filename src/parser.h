 ...
 *
 * This file defines the YAML::Parser class which processes YAML input strings
...
/**
 * @class YAML::Parser
 * @brief Parser for YAML documents that converts YAML to Godot Variants.
 *
 * The Parser class handles the conversion of YAML documents to Godot's native
...
private:
	/**
	 * @brief Parser components from ryml library.
	 */
	ryml::Tree tree;
	 ...
	 * @param user_data User data pointer (typically the Parser instance)
	 */
