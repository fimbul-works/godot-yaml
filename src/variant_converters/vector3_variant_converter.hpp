/**
 * @file vector3_variant_converter.hpp
 * @brief Defines the YAMLVector3VariantConverter for YAML serialization of Godot Vector3 type.
 *
 * This file contains the YAMLVector3VariantConverter class which handles the conversion
...
/**
 * @class YAMLVector3VariantConverter
 * @brief Converter for Godot Vector3 type to/from YAML format.
 *
 * The YAMLVector3VariantConverter class provides functionality to:
 ...
 */
class YAMLVector3VariantConverter : public YAMLVariantConverter {
public:
	/**
...
private:
	 ...
	 */
	Vector3 decode_from_map(const ryml::ConstNodeRef &node, YAMLParserContext *context) const;
	 ...
	 */
	Vector3 decode_from_sequence(const ryml::ConstNodeRef &node, YAMLParserContext *context) const;
};
