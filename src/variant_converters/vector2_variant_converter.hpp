/**
 * @file vector2_variant_converter.hpp
 * @brief Defines the YAMLVector2VariantConverter for YAML serialization of Godot Vector2 type.
 *
 * This file contains the YAMLVector2VariantConverter class which handles the conversion
...
/**
 * @class YAMLVector2VariantConverter
 * @brief Converter for Godot Vector2 type to/from YAML format.
 *
 * The YAMLVector2VariantConverter class provides functionality to:
 ...
 */
class YAMLVector2VariantConverter : public YAMLVariantConverter {
public:
	/**
...
private:
	 ...
	 */
	Vector2 decode_from_map(const ryml::ConstNodeRef &node, YAMLParserContext *context) const;
	 ...
	 */
	Vector2 decode_from_sequence(const ryml::ConstNodeRef &node, YAMLParserContext *context) const;
};
