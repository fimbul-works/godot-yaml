/**
 * @file rect2_variant_converter.hpp
 * @brief Defines the YAMLRect2VariantConverter for YAML serialization of Godot Rect2 type.
 *
 * This file contains the YAMLRect2VariantConverter class which handles the conversion
...
/**
 * @class YAMLRect2VariantConverter
 * @brief Converter for Godot Rect2 type to/from YAML format.
 *
 * The YAMLRect2VariantConverter class provides functionality to:
 ...
 */
class YAMLRect2VariantConverter : public YAMLVariantConverter {
public:
	/**
	 ...
	 */
	explicit YAMLRect2VariantConverter(YAMLVariantConverterFactory *factory);
...
private:
	 ...
	 */
	Rect2 decode_from_map(const ryml::ConstNodeRef &node, YAMLParserContext *context) const;
	 ...
	 */
	Rect2 decode_from_sequence(const ryml::ConstNodeRef &node, YAMLParserContext *context) const;
