/**
 * @file vector4i_variant_converter.hpp
 * @brief Defines the YAMLVector4iVariantConverter for YAML serialization of Godot Vector4i type.
 *
 * This file contains the YAMLVector4iVariantConverter class which handles the conversion
...
/**
 * @class YAMLVector4iVariantConverter
 * @brief Converter for Godot Vector4i type to/from YAML format.
 *
 * The YAMLVector4iVariantConverter class provides functionality to:
 ...
 */
class YAMLVector4iVariantConverter : public YAMLVariantConverter {
public:
	/**
...
private:
	 ...
	 */
	Vector4i decode_from_map(const ryml::ConstNodeRef &node, YAMLParserContext *context) const;
	 ...
	 */
	Vector4i decode_from_sequence(const ryml::ConstNodeRef &node, YAMLParserContext *context) const;
};
