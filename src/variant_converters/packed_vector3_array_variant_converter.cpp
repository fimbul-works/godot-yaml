...
void YAMLPackedVector3ArrayVariantConverter::encode(
...
Variant YAMLPackedVector3ArrayVariantConverter::decode(
	...
	if (size > 0) {
		for (size_t i = 0; i < size; ++i) {
			try {
				...
				throw YAMLException(vformat("Failed to decode PackedVector3Array value at index %d: %s",
