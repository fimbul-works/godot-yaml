/**
 * @file packed_byte_array_variant_converter.hpp
 * @brief Defines the YAMLPackedByteArrayVariantConverter for YAML serialization of Godot PackedByteArray type.
 *
 * This file contains the YAMLPackedByteArrayVariantConverter class which handles the conversion
...
/**
 * @class YAMLPackedByteArrayVariantConverter
 * @brief Converter for Godot PackedByteArray type to/from YAML format.
 *
 * The YAMLPackedByteArrayVariantConverter class provides functionality to:
 ...
 */
class YAMLPackedByteArrayVariantConverter : public YAMLVariantConverter {
public:
	/**
...
private:
	 ...
	 */
	String cleanup(const ryml::csubstr &input, const ryml::ConstNodeRef &node, YAMLParserContext *context) const;
