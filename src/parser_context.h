 ...
 * @brief Defines the ParserContext class for YAML parsing state management.
 *
 * This file contains the ParserContext class which maintains state during YAML
 ...
 *
 * The ParserContext class manages state during YAML parsing, particularly
...
public:
	/**
	 * @brief Constructs a new ParserContext instance.
	 *
