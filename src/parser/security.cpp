...
YAMLSecurity::View::View(const std::unordered_map<PathPattern, std::vector<StringName>, std::hash<PathPattern>, std::equal_to<PathPattern>> &p_allowed_paths_with_types, const std::unordered_set<StringName, StringNameHasher> &p_blocked_types) :
