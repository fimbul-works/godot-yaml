 ...
 *
 * This file contains the VariantConverter abstract base class which provides
...
/**
 * @brief Macro to define YAML tag information for a converter class.
 *
 ...
 *
 * The VariantConverter class defines the interface for type-specific converters
